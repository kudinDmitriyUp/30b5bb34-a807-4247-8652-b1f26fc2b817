...
export const metadata: Metadata = {
  ...
  description: "Discover luxury clothing and designer fashion pieces for the modern lifestyle. Shop our curated collection of premium garments.",
  keywords: "luxury fashion, designer clothing, premium wear, elegant style, fashion collection",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "Luxe - Premium Fashion Collection",
    description: "Discover luxury clothing and designer fashion pieces for the modern lifestyle",
    siteName: "Luxe",
    type: "website"
  },
  twitter: {
    ...
    title: "Luxe - Premium Fashion Collection",
    description: "Discover luxury clothing and designer fashion pieces"
  }
};
